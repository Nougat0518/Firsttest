...
public class DeployPickActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deploy_pick);
        ...
        findViewById(R.id.takephotobt).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    //大于等于版本24（7.0）的场合
                    imageUri = FileProvider.getUriForFile(DeployPickActivity.this, "com.Nougat.mexp.activity.fileprovider", newFile);//此处的outputImage指定的路径要在file_paths.xml文件对应配置path指定路径的子路径
                } else {
        ...
        findViewById(R.id.confirm_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(order_distribut_type.equals("pickbigexp")){
                    intent.putExtra("money","5");
                }else {
                    intent.putExtra("money","3");}
                intent.setClass(DeployPickActivity.this,UserPaymentActivity.class);
    ...
    private void invitview() {
        //imageView.findViewById(R.id.confirm_button);
        //imageView=findViewById(R.id.imges123);
        editText[0]=findViewById(R.id.mingzi);
        editText[1]=findViewById(R.id.haoma);
        editText[2]=findViewById(R.id.dizhi);
...
//拍照事件回调
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.goback:
                startActivity(new Intent(this, PickExpActivity.class));
                finish();
                break;
        }
    }
