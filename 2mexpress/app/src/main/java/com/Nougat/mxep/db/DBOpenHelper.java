...
public class DBOpenHelper extends SQLiteOpenHelper {
    final  static String DB_Name="mexpNougat.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE `tb_user`("+
                ...
                "primary key(`user_id`));");
        db.execSQL("insert into `tb_user` values ('u101','123456','djm','19381086916','150.0','成都职业技术学院（高新校区)','0','')");
        db.execSQL("insert into `tb_user` values ('u102','123456','djm','19381766906','20.1','成都职业技术学院（高新校区)','1','')");
        //创建配送员表
        ...
        db.execSQL("insert into `tb_distributor` values ('d101','123456','杜小双','511321999800201150','17381086916','500',0,0,'')");
        //创建管理员表
        ...
        //预存数据
        db.execSQL("insert into `tb_order` values (null,'Nougat','d101','代发大件',5.0,'杜小双','17381086916','2325','2020/09/10 18:06:23',null,0,null,'取件码e86952')");
        db.execSQL("insert into `tb_order` values (null,'nzt','d101','代发大件',5.0,'杜小双','17381086916','2325','2020/09/10 18:06:23',null,1,null,'取件码e86952')");
    }
    @Override
